...
class AddCustomer:
    ...
    txtbox_customerroles_xpath="//div[@class='k-multiselect-wrap k-floatwrap'][@role='listbox']"
    ...
    def clickmanagerofvendor(self,value):
